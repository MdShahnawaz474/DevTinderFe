...
const Request = () => {
  ...
  // console.log(requestsFromStore);

  const requests: RequestType[] = Array.isArray(requestsFromStore)
    ? requestsFromStore
    : [];
                ...
                <div className="p-5">
                  <h3 className="text-2xl font-bold text-yellow-400 mb-2 -mt-6">
                    {request.fromUserId.firstName.charAt(0).toUpperCase() +
                      request.fromUserId.firstName.slice(1)}{" "}
                    {request.fromUserId.lastName.charAt(0).toUpperCase() +
                      request.fromUserId.lastName.slice(1)}
                  </h3>
                  ...
                  <div className="flex justify-between items-center mt-1 text-gray-300">
                    <span>{request.fromUserId.gender || "Not specified"}</span>
                    <span>{request.fromUserId.age || "Not specified"}</span>
                  </div>
                  ...
                  <div className="mt-3 flex flex-col space-y-3">
                    ...
                    <div className="flex space-x-4">
                      ...
                      <button
                        className="flex-1 bg-red-500 hover:bg-red-600 text-white py-2 px-4 rounded-full transition-colors font-medium flex items-center justify-center"
                        onClick={() =>
                          fetchReviewRequest("rejected", request._id)
                        }
                      >
                        <span className="mr-2">✕</span>
                        <span className="flex items-center">
